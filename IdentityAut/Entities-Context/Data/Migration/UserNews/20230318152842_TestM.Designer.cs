...
namespace Entities_Context.Data.Migration.UserNews
{
    ...
    [Migration("20230318152842_TestM")]
    partial class TestM
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities_Context.Entities.UserNews.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities_Context.Entities.UserNews.Theme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities_Context.Entities.UserNews.User", b =>
                {
                    b.HasOne("Entities_Context.Entities.UserNews.Role", "Role")
                        .WithMany("Users")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities_Context.Entities.UserNews.Theme", "Theme")
                        .WithMany("Users")
