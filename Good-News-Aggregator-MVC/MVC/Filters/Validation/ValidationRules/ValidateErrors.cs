namespace MVC.ValidationRules
{
    internal interface ValidateErrors
    {
        ...
        protected const String IncorrectId = "Некорректный id";

        protected const String NoText = "Комментарий пуст";
        
        protected const String BadName = "Некорректное имя";

        protected const String ToMuchText = "Максимальное количество символов - 50";

        protected const String BadText= "Текст содержит запрещенные символы";
